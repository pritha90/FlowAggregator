...
curl -X POST "http://localhost:8080/flows" -H 'Content-Type: application/json' -d "[{\"src_app\": \"foo\", \"dest_app\": \"bar\", \"vpc_id\": \"vpc-1\", \"bytes_tx\":300, \"bytes_rx\": 800, \"hour\": 2},{\"src_app\": \"foo\", \"dest_app\": \"bar\", \"vpc_id\": \"vpc-1\", \"bytes_tx\":300, \"bytes_rx\": 800, \"hour\": 1}]"
